...
<head>
    ...
    <script type="text/javascript">
        ...
        function editRemark(id) {
            //为修改备注信息的模态窗口的隐藏域绑定id
            $("#remarkId").val(id);
            //找到指定存放备注信息的H5标签
            var noteContent = $("#e"+id).html();

            //将H5中的备注信息展现到修改的模态窗口中
            $("#noteContent").val(noteContent);
            //以上处理完成后打开修改备注信息的模态窗口
...
<%--            <h5>哎呦！</h5>--%>
<%--            <font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;">--%>

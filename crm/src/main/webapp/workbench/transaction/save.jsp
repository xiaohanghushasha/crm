...
<head>
    ...
    <script type="text/javascript" src="jquery\bs_typeahead\bootstrap-typeahead-min.js"></script>
...
<form action="workbench/transaction/save.do" id="TranBtn" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" value="强奸" id="create-activitySrc" name="activityId">
            <input type="hidden" value="d09c3e55b1d64a3f9dd9cd0fe7294e6f">
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);"
                ...
                class="glyphicon glyphicon-search"></span></a></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" value="马云" id="create-contactsName" name="contactsId">
            <input type="hidden" value="0811ab56a91549bcb7657d6d99891e0a">
        </div>
    </div>

...
<head>
    ...
    <script type="text/javascript">
        ...
        function changeIcon(stage, index0) {
            ...
            //如果当前阶段的可能性为0，前7个一定是黑圈，后两个一个是红叉一个黑叉
            ...
            //如果当前阶段的可能性不为0，前7个绿圈，绿标记，黑圈，后两个一定是黑叉
            else {
                //遍历前7个，绿圈，绿标记，黑圈
                for (var i=0;i<point;i++){
                    //如果是当前阶段
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    <%
        ...
        //判断当前阶段
        //如果当前阶段的可能性为零，前七个一定是黑圈，后两个一个是红叉一个是黑叉
        if ("0".equals(currentPossibility)) {

            for (int i = 0; i < dvList.size(); i++) {
                //取得每一个遍历出来的阶段，根据其阶段取可能性
                DicValue dv = dvList.get(i);
    ...
    //如果当前阶段的可能性不为零,前七个有可能性是绿圈，绿色标记，黑圈，后两个一定是黑叉
    else {
    ...
    //如果遍历出来的阶段可能性不为0，说明是前七个阶段，绿圈，绿标记，黑圈
    else {
